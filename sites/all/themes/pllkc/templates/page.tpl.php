<div id="banner">
    ...
    <div id="branding">
    <div id="logo">
    	<a title="Home page" href="/"><img src="<?php print '/' . path_to_theme() . '/logo_small.png'; ?>" alt="Public Law Library of King County logo" /></a></div>
      
      <?php if ($site_name || $site_slogan): ?>
        <hgroup<?php if (!$site_slogan && $hide_site_name): ?> class="<?php print $visibility; ?>"<?php endif; ?>>
          <?php if ($site_name): ?>
            <h1 id="site-name"<?php if ($hide_site_name): ?> class="<?php print $visibility; ?>"<?php endif; ?>><a title="Home Page" href="/">Public Law Library <span class="of">of</span> King County</a></h1>
          <?php endif; ?>
          <?php if ($site_slogan): ?>
